        ...
        <div>
            ...
            <div class="mt-2">
                ...
                <div id="nospwd_div" runat="server" visible="false">
                    <asp:Button runat="server" Text="确定支付" class="btn btn-info btn-lg ml-2 confirmPay" OnClick="Confirm_Click" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <a id="PayComp_Href" runat="server" href="/Extend/order.aspx" class="btn btn-info">已完成支付</a>
