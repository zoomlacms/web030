...
<asp:Content runat="server" ContentPlaceHolderID="head" EnableViewState="false"><title>会员管理</title></asp:Content>
...
<div runat="server" id="sel_box" class="sel_box">
    <div class="input-group">
        ...
        <asp:TextBox runat="server" class="form-control max20rem" ID="UserID_T" placeholder="用户ID"/>
        <asp:TextBox runat="server" class="form-control max20rem" ID="UName_T"  placeholder="用户名,昵称"/>
...
<th scope="col">用户名</th>
<th scope="col" style="width:260px;">用户信息</th>
...
<td>
    <div>昵称：<%#Eval("HoneyName") %></div>
    <div>真名：<%#Eval("Permissions") %></div>
    <div>手机：<%#Eval("Mobile") %></div>
</td>
