...
<title>预览内容</title>
    ...
    #fd_tr_yhid,#fd_tr_sq,#fd_tr_quid,#fd_tr_qu,#fd_tr_gddd{display:none;}
    </style>
    <!--用户ID,商圈-->
    ...
    <div class="row sysRow list_choice">
        ...
        <div class="tab-content table-responsive">
            <div class="tab-pane fade in active show" id="base">
                <table class="table table-bordered sys_table">
                    ...
                    <tr>
                        <th>
                            <asp:Label runat="server" ID="C_Title_L"></asp:Label></th>
                        <td>
                            <asp:Label ID="Title_L" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="html_td"></tr>
                    <tr style="display:none;"><th class="fd_td_l">主编辑器扩展图</th><td><img runat="server" id="topimg_img" class="img_100" onerror="shownopic(this);" /></td></tr>
                </table>
                <script>
        ...
        <div class="text-center Conent_fix">
            <a href="EditContent.aspx?GeneralID=<%:Gid %>" class="btn btn-outline-info mb-2">修改内容</a>
				&nbsp;<asp:Button ID="Del_Btn" CssClass="btn btn-outline-danger mb-2" runat="server" Text="删除信息" OnClientClick="return confirm('你确定将该数据删除到回收站吗？')" OnClick="delete_Click" />
				&nbsp;<asp:Button ID="Reject_Btn" CssClass="btn btn-outline-danger mb-2" runat="server" Text="直接退稿" OnClick="Reject_Btn_Click" Visible="false" />
				&nbsp;<asp:Button ID="UnAudit_Btn" CssClass="btn btn-outline-danger mb-2" runat="server" Text="取消审核" OnClick="UnAudit_Btn_Click" Visible="false"  />
                ...
                <a href="/Item/<%:Gid %>.aspx" target="_blank" class="btn btn-outline-info mb-2">浏览信息</a>
        </div>
    </div>
	</div>
</asp:Content>
