...
<div class="row">
	...
	<div class="table-responsive-md">
       ...
       <ZL:Repeater ID="RPT" runat="server" PageSize="10" PagePre="<tr><td><input type='checkbox' id='AllID_Chk' /></td><td colspan='15'><div class='text-center'>"
        PageEnd="</div></td></tr>">
           <ItemTemplate>
               <tr>
                   <td><input type="checkbox" name="idchk" value='<%#Eval("id") %>' /></td>
                   <td><%#Eval("ID") %></td>
                   <td><a href="ShowProduct.aspx?id=<%#Eval("id")%>">
                       ...
                       <div class="Ctitle sys_userPopver" onmouseover="ShowPopover(this)">
                           ...
                           <div class="popover bs-popover-right popbox">
                               ...
                               <div class="popover-body">
                                   <table>
                                       <tr>
                                           <td scope="col" class="text-right">发布者：</td>
                                           <td scope="col"><%#Eval("AddUser") %></td>
                                       </tr>
                                       <tr>
                                           <td scope="col">发布时间：</td>
                                           <td scope="col"><%#Eval("AddTime") %></td>
                                       </tr>
                                       <tr>
                                           <td scope="col">所在店铺：</td>
                                           <td scope="col"><%# string.IsNullOrEmpty(Eval("StoreName","")) ? "自营商城" : Eval("StoreName","") %></td>
                                       </tr>
                                       <tr>
                   ...
                   <td><%#Eval("AddUser") %></td>
                   <td><%#Eval("ProUnit") %></td>
                   <td><a onclick="showStock(<%#Eval("ID") %>);" title="库存管理"><%#ShowStockNum()%></a></td>
                   <td><%#GetPrice()%></td>
                   <td><%#formatnewstype(Eval("ProClass",""))%></td>
                   <td><%#GetProAttr() %></td>
                   <td><%#formattype(DataBinder.Eval(Container,"DataItem.Sales","{0}"))%></td>
                   <td><%#GetStatus() %></td>
                   <td>
